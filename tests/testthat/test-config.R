...
test_that("the 11 export rank columns are present and ordered", {
  src("config.R")
  expect_length(TAXON_RANK_COLUMNS, 11)
  expect_equal(TAXON_RANK_COLUMNS[1], "taxon_kingdom_name")
  expect_equal(TAXON_RANK_COLUMNS[11], "taxon_subspecies_name")
})
