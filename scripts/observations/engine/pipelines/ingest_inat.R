...
if (!exists("inat_request_text"))     source("scripts/observations/engine/api/inat_http.R")
if (!exists("write_observations_page")) source("scripts/observations/engine/db/observations_store.R")
