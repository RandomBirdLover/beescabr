...
packages_md <- function(config_path = "scripts/config.R") {
  ...
  out <- c("# Packages", "",
           ...
           "uses is installed.", "",
           "*Generated, so do not edit this file. The list lives in `config.R`; to change it,",
  ...
  c(out, "",
    "## Adding one", "",
    "Add it to `BEESCABR_PACKAGES` in `config.R`. That is the whole change, because every",
