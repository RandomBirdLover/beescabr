# =============================================================
# utils/parse_beeple_calendars.R
...
#
# Run: source("scripts/utils/parse_beeple_calendars.R"); parse_all_calendars()
# =============================================================
...
parse_all_calendars <- function(dir = CALENDAR_DIR, out = WINDOWS_OUT, write = TRUE) {
...
if (!exists("BEESCABR_SOURCED_BY_RUNNER") && sys.nframe() == 0) parse_all_calendars()
