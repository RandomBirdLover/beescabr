...
RARE_COMPARISON <- c(method = "photos_vs_specimens", observer = "beeple_vs_interns")
...
RARE_WINDOWS <- list(
  by_method = list(
    ...
    group = "obs_type", levels = c("observation", "specimen"),
    title = "At equal effort, do photos or specimens find more bees?"),
  by_observer = list(
