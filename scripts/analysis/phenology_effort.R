...
#
# The intern survey window is Mar-Oct; this calendar shows exactly how effort
...
message("Trips in Mar-Oct window: ",
...
gA <- ggplot(long, aes(x = month_lab, y = value, fill = in_window)) +
  ...
  scale_fill_manual(values = c("TRUE" = "#1a9850", "FALSE" = "#cccccc"),
                    labels = c("TRUE" = "Mar-Oct window", "FALSE" = "outside window"), name = NULL) +
